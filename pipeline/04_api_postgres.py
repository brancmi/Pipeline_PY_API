#Exemplo salvando utilizado postgres com render
import requests
from sqlalchemy import create_engine, Column, String, Float, Integer, DateTime #para criar o schema do banco de dados
from sqlalchemy.orm import declarative_base, sessionmaker #para fazer insert e update
